...
import IssuesTable from '@/views/Project/R/IssuesTable'
import CreateRelease from '@/views/Project/R/CreateRelease'
import ReleaseTable from '@/views/Project/R/ReleaseTable'
