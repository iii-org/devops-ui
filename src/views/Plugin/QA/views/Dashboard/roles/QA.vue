  ...
  <el-row class="app-container">
    <el-row type="flex" :gutter="10" class="flex-wrap">
      ...
      <el-col :xs="24" :sm="24" :md="7">
        <el-card>
          <template slot="header">
            <span class="font-weight-bold"> 專案品質
            </span>
          </template>
          <QAProjectQuality />
        </el-card>
    ...
    <el-row type="flex" class="flex-wrap" :gutter="10">
      <el-col :xs="24" :sm="24" :md="24">
        <el-card>
          <div slot="header" class="pointer" @click="$refs['projectMemberList'].detailDialog=true">
            <span class="font-weight-bold">{{ $t('Dashboard.ADMIN.ProjectMembers.NAME') }}
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" width="1em" height="1em"
                   style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);"
                   preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"
          ...
          <QAProjectMemberList ref="projectMemberList" :data="getIssueRankData" />
        </el-card>
      </el-col>
    </el-row>
  </el-row>
...
import QAProjectQuality from '../components/QAProjectQuality'
import QAProjectMemberList from '../components/QAProjectMemberList'
