      ...
      <el-table-column label="適用分級">
        <el-table-column label="低" width="75px">
          <template slot-scope="prop">
            <em v-if="prop.row.low" class="el-icon-check" />
          </template>
        </el-table-column>
        <el-table-column label="中" width="75px">
          <template slot-scope="prop">
            <em v-if="prop.row.middle" class="el-icon-check" />
          </template>
        </el-table-column>
        <el-table-column label="高" width="75px">
          <template slot-scope="prop">
            <em v-if="prop.row.high" class="el-icon-check" />
          </template>
        </el-table-column>
      </el-table-column>
    ...
    return {
      data: [
        ...
        },
        {
          category: '身分驗證',
          item:
            '4.6 具備帳戶鎖定機制，帳號登入進行身分 驗證失敗達 3 次後，至少 30 分鐘內不允 許該帳號及來源 IP 繼續嘗試登入',
          low: '',
          middle: '',
          high: 'TRUE'
        },
