export default {
  ...
  'arguments': {
    ...
    'excalidraw-db-account': { title: 'DB User Name', hint: 'please enter the db user account', placeholder: 'DB User Account' },
    'excalidraw-db-password': { title: 'DB User Password', hint: 'please enter the db user password', placeholder: 'DB User Password' }
  }
}
